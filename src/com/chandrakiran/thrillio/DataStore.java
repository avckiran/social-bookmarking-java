...
import com.chandrakiran.thrillio.constants.Gender;
...
public class DataStore {
	...
	private static void loadUsers() {
		users[0] = UserManager.getInstance().createUser(1000, "user0@chandrakiran.com", "test", "John", "M",
				Gender.MALE, UserType.USER);
		users[1] = UserManager.getInstance().createUser(1001, "user1@chandrakiran.com", "test", "Sam", "M", Gender.MALE,
				UserType.USER);
		users[2] = UserManager.getInstance().createUser(1002, "user2@chandrakiran.com", "test", "Anita", "M",
				Gender.FEMALE, UserType.EDITOR);
		users[3] = UserManager.getInstance().createUser(1003, "user3@chandrakiran.com", "test", "Sara", "M",
				Gender.FEMALE, UserType.EDITOR);
		users[4] = UserManager.getInstance().createUser(1004, "user4@chandrakiran.com", "test", "Dheeru", "M",
				Gender.MALE, UserType.CHEIF_EDITOR);
	}
